...
  // Aseguramos que HttpClientModule esté disponible para usar el servicio
...
  // Modelos para el NgModel (filtros)
...
        // NOTA: Aquí deberías usar un modal o snackbar en lugar de alert()
        // alert('Error al cargar los usuarios. Verifique la conexión con el servidor.');
      },
    });
  }
...
    // NOTA: Aquí deberías usar un modal de confirmación en lugar de confirm()
    if (
      obstetra &&
...
            // alert('Error al inhabilitar el usuario. Verifique el log.');
          },
        });
...
            // alert('Error al activar el usuario. Verifique el log.');
          },
        });
      }
    }
...
    // La lógica de mostrar el modal de Bootstrap se maneja en el HTML con data-bs-toggle
  }
