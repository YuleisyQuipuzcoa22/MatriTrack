...
MatriTrack es un **Sistema Integral Full-Stack** diseñado para la gestión clínica del personal de **Obstetricia** (MINSA). Su objetivo principal es automatizar el **seguimiento de mujeres en etapa de gestación y puerperio**, garantizando la integridad del historial clínico, la trazabilidad de los controles y la gestión de resultados de análisis.
...
- **Controles y Análisis:** Registro de controles médicos y resultados de análisis con manejo de carga de archivos (PDF) en el backend.
...
1. **Requisitos:** Instalar Node.js y MySQL.
